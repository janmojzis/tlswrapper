...
(
  (
    ...
    echo "tlswrappernojail: tlswrapper-test"
    echo "	ln -sf tlswrapper-test tlswrappernojail"
    echo

    echo "tlswrappernojail-tcp: tlswrapper-test"
    echo "	ln -sf tlswrapper-test tlswrappernojail-tcp"
    echo

    echo "tlswrappernojail-smtp: tlswrapper-test"
    echo "	ln -sf tlswrapper-test tlswrappernojail-smtp"
    echo

    echo "test: \$(BINARIES) tlswrappernojail tlswrappernojail-tcp tlswrappernojail-smtp"
    ...
    echo "clean:"
    echo "	rm -f *.log *.o *.out \$(BINARIES) libs tlswrappernojail tlswrappernojail-tcp tlswrappernojail-smtp has*.h"
    echo 
