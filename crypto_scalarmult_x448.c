...
int crypto_scalarmult_x448(unsigned char *out, const unsigned char *scalar, const unsigned char *base) {
...
int crypto_scalarmult_x448_base(unsigned char *q, const unsigned char *n) {
    return crypto_scalarmult_x448(q, n, X448_BASE_POINT);
}
