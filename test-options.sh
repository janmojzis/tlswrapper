...
tlswrappernojail -Q -d testfifo </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
echo 'tlswrapper rejects fifo as a certfile'
tlswrappernojail -Q -f testfifo </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
echo 'tlswrapper rejects fifo as a anchorfile'
tlswrappernojail -Q -a testfifo </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
echo 'tlswrapper rejects nonexistent file as a certdir'
tlswrappernojail -Q -d notexist </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
echo 'tlswrapper rejects nonexistent file as a certfile'
tlswrappernojail -Q -f notexist </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
echo 'tlswrapper rejects nonexistent file as a anchorfile'
tlswrappernojail -Q -a notexist </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
echo 'tlswrapper rejects regular file as a certdir'
tlswrappernojail -Q -d testfile </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
echo 'tlswrapper rejects directory as a certfile'
tlswrappernojail -Q -f testdir </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
echo 'tlswrapper rejects directory as a anchor file'
tlswrappernojail -Q -a testdir </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
echo 'tlswrapper rejects link to regular file as a certdir'
tlswrappernojail -Q -d testfilelink </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
echo 'tlswrapper rejects link to directory as a certfile'
tlswrappernojail -Q -f testdirlink </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
echo 'tlswrapper rejects link to directory as a anchorfile'
tlswrappernojail -Q -a testdirlink </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo

# TLS version
echo 'tlswrapper rejects bad min TLS version'
tlswrappernojail -Q -f testfile -m xxx </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
...
tlswrappernojail -Q -f testfile -c xxx </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo

# ephemeral 
echo 'tlswrapper rejects bad ephemeral name'
tlswrappernojail -Q -f testfile -e xxx </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo

# proxy protocol
echo 'tlswrapper rejects bad proxy protocol version'
tlswrappernojail -Q -f testfile -P 9 </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo

# user from client cert. 
echo 'tlswrapper rejects bad ASN.1 object'
tlswrappernojail -Q -f testfile -U xxx </dev/null 2>&1 | sed 's/ (.*)/ /'
echo $?; echo
